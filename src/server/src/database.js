...
const ContactChannelModel = require('./models/ContactChannel');
...
const Contact = ContactModel(sequelize, Sequelize, Company, City);
const ContactChannel = ContactChannelModel(
  sequelize,
  Sequelize,
  Contact,
  Channel
